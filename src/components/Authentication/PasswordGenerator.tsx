...
const PasswordGenerator = ({
  ...
  return (
    <div
      className={`password-generator-overlay ${animatedIn ? 'visible' : ''}`}
      onClick={handleClose}
    >
      <div
      ...
      >
        ...
        <div className='modal-content'>
          ...
          <div className='password-options'>
            ...
            <div className='checkbox-group'>
              ...
              <div className='option-checkbox'>
                ...
                />
                <label htmlFor='easyToRead'>
                  Easy to Read (exclude ambiguous symbols)
                </label>
              </div>
            </div>
          </div>
          ...
          <div className='password-tips'>
            ...
            <p>
              Like in chess, a strong password combines multiple strategies. Use
              a mix of characters and adequate length for best security.
            </p>
          </div>
        </div>
